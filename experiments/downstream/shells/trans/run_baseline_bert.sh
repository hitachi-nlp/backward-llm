...
#PBS -o logs/baseline_'$dataset'_bert-2layer_seed'$seed'.txt
#PBS -e logs/baseline_'$dataset'_bert-2layer_seed'$seed'.txt
#PBS -j oe
...
accelerate launch train_baseline.py \
    ...
    --outdir models/'$dataset'/bert-base-cased/baseline_2layers/seed'$seed' \
    --epoch 20 \
    --max_len 512 \
    --batch_size 32 \
    --accumulation 1 \
